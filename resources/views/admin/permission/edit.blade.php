        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" action="{{ route('permission.update', $permission->id) }}" autocomplete="off">
                        @csrf
                        <div class="form-group">
                            <label for="name">Tên quyền<span class="claim">*</span></label>
                            <input type="text" placeholder="Nhập tên quyền" class="form-control" name="name" id="name" value="{{ $permission->name }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Nhập slug" class="form-control" name="slug" id="slug" value="{{ $permission->slug }}">
                            @error('slug')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <textarea class="form-control message-input" name="description" id="description">{{ $permission->description }}</textarea>
                            @error('description')
                                <p class="error">{{ $message }}</p>
                            @enderror
                        </div>
