                ...
                <div class="ibox-content">
                    <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="{{ route('post.update', ['id' => $post->id]) }}" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="editor form-control message-input" name="content">{{$post->content}}</textarea>
                                @error('content')
                                    <p class="error">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10 mt-2">
                                <div class="checkbox checkbox-danger">
                                    <input id="is_outstanding" type="checkbox" name="is_outstanding" {{$post->is_outstanding == 1 ? "checked" : ""}}>
